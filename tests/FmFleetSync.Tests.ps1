...
BeforeAll {
    ...
    # Invoke-FmFleetSync runs the supervision guard against the home it
    # resolves, and with nothing pinned that is this checkout - in the primary
...
Describe 'the home this file runs in' {
    It 'is under TestDrive, never the checkout, because the guard Invoke-FmFleetSync runs writes to it' {
