...
install_autoarm_scripts() {
  ...
  # fm-session-lock-lib sources the portable process primitives; a fixture
  # without them makes the copied hook die at source time and read as inert.
  cp "$ROOT/bin/fm-psproc-lib.sh" "$dir/bin/fm-psproc-lib.sh"
