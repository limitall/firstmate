...
. "$FM_AFK_START_DIR/fm-psproc-lib.sh"
...
daemon_pid_matches() {
  ...
  # The identity file is the primary evidence; this is the pre-identity
  # fallback, matching the daemon by the script path in its argument vector.
