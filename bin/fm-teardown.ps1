...
if ($TaskId -in @('-h', '--help') -or
    ...
    @(
        ...
        ''
        'A kind=secondmate task RETIRES that secondmate: its home is removed and its'
        'data/secondmates.md row is dropped last of all, once the home is finished with.'
        'It refuses while that home has a live descendant holding a lock, work under way'
        'in its own backlog or state records, or work that has not landed.'
        ''
        '  --force          skip the landed-work test, the scout report gate, and a'
        '                   secondmate''s discard refusals. This DISCARDS work, so it'
        '                   requires --approved-by. It NEVER overrides a live descendant'
        '                   of a secondmate home.'
